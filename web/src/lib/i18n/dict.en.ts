...
const en: Dict = {
  ...
  "playground.h1": "Pi Playground",
  "playground.body": "v0.5.14+ — Pilot bridge to",
  "playground.bodyWs": "via WebSocket. Each browser tab gets a fresh",
  "playground.bodySpawn": "child process.",
  "playground.status.idle": "Click Connect to start",
  "playground.status.fetchingToken": "Reading auth token…",
  "playground.status.connecting": "Opening WebSocket…",
  "playground.status.connected": "Connected — pi is running in the background",
  "playground.status.disconnected": "Disconnected",
  "playground.status.errorUnknown": "Error: unknown",
  "playground.action.connect": "Connect",
  "playground.action.disconnect": "Disconnect",
  "playground.action.send": "▶ Send",
  "playground.action.newSession": "↻ New session",
  "playground.action.abort": "⏹ Abort",
  "playground.prompt.label": "Prompt",
  "playground.prompt.placeholder":
    'e.g. "List the files in the current directory"',
  "playground.events.title": "Event stream",
  "playground.events.clear": "clear",
  "playground.events.emptyConnected":
    "Connected. Send a prompt to see streaming events.",
  "playground.events.emptyDisconnected": "Not connected.",
  // v0.4.14: nav groups
