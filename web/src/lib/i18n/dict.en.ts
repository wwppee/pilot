...
const en: Dict = {
  ...
  "nav.plans": "Plans",
  "nav.try": "Try pi",
  // v1.0.1: 7-module nav labels.
  "nav.hub": "Hub",
  "nav.workflow": "Workflow",
  "nav.policySafe": "Policy & Security",
  "nav.insight": "Insight",
  "nav.settings": "Settings",
  // v1.0.1: 4 new module page titles + subtitles.
  "hub.h1": "Hub",
  "hub.subtitle": "Search, install, and manage agent capabilities.",
  "workflow.h1": "Workflow",
  "workflow.subtitle": "Visual orchestration of multi-step tasks.",
  "insight.h1": "Insight",
  "insight.subtitle": "Real-time dashboard, alerts, and cost analysis.",
  "settings.h1": "Settings",
  "settings.subtitle": "Profiles, avatars, and system preferences.",
  // v1.0.1: "coming soon" panels on the 4 new placeholder pages.
  "hub.comingSoon.title": "Hub ships in v1.0.2",
  "hub.comingSoon.body": "The Capability Hub will merge the four legacy surfaces (Packages / Forge / Capabilities / Tools) into one search-driven page. Until then, the routes below still work and land you here.",
  "hub.comingSoon.routes": "Old routes that redirect here:",
  "workflow.comingSoon.title": "Workflow ships in v1.0.2",
  "workflow.comingSoon.body": "The Workflow module will merge Compose (visual canvas) / Plans (decomposed goals) / Workflows (reusable templates) into one editor. The canvas stays the primary view; the data model unifies underneath.",
  "workflow.comingSoon.routes": "Old routes that redirect here:",
  "insight.comingSoon.title": "Insight ships in v1.0.2",
  "insight.comingSoon.body": "The Insight module will merge Observability (raw tool-call records) / Usage (today / week token + USD) into one real-time dashboard. Alert rules and call-chain tracing follow in v1.0.3 / v1.0.4.",
  "insight.comingSoon.routes": "Old routes that redirect here:",
  // v1.1.0: real Insight page copy.
  "insight.stat.sessions": "Sessions",
  "insight.stat.messages": "Messages",
  "insight.stat.tokens": "Tokens",
  "insight.stat.cost": "Cost (USD)",
  "insight.section.byModel": "By model",
  "insight.section.byTool": "By tool",
  "insight.section.recent": "Recent sessions",
  "insight.empty.models": "No model usage yet today.",
  "insight.empty.tools": "No tool usage yet today.",
  "insight.empty.sessions": "No sessions yet today.",
  "insight.col.id": "ID",
  "insight.col.cwd": "CWD",
  "insight.col.lastUsed": "Last used",
  "insight.col.entries": "Entries",
  "insight.footer.legacy": "These legacy surfaces are still available while the merge is in progress:",
  "settings.comingSoon.title": "Settings ships in v1.0.2",
  "settings.comingSoon.body": "The Settings module will merge Profiles / Avatars / Help into one tabbed page, plus a new System tab for theme / language / data cleanup. None of the underlying storage changes — just one menu entry replaces three.",
  "settings.comingSoon.routes": "Old routes that redirect here:",
  // v1.0.2: Hub page copy.
  "hub.subtitle.idle": "Search npm, local, and built-in capabilities. Install with one click.",
  "hub.subtitle.search": "{n} result{s} for “{q}”.",
  "hub.section.searchResults": "Search results",
  "hub.section.installed": "Installed",
  "hub.section.capabilities": "Capabilities",
  "hub.installedCount": "{n} pack{s}",
  "hub.capCount": "{n} capability{cap_s}",
  "hub.search.placeholder": "Search capabilities (e.g. csv parser, jwt, mongodb)",
  "hub.search.submit": "Search",
  "hub.search.empty.title": "No results for “{q}”",
  "hub.search.empty.hint": "Try a shorter query, or check the spelling.",
  "hub.installed.empty.title": "Nothing installed yet",
  "hub.installed.empty.hint": "Use the search bar above to find a capability and install it.",
  "hub.capabilities.empty.title": "No absorbed capabilities",
  "hub.capabilities.empty.hint": "Absorb a pack via Forge to reuse it across projects.",
  "hub.capabilities.empty.hintForge": "Open Forge →",
  "hub.footer.legacy": "These legacy surfaces are still available while the merge is in progress:",
  "hub.action.install": "Install",
  "hub.action.uninstall": "Uninstall",
  "hub.action.view": "View",
  "hub.row.version": "v",
  "hub.row.author": "by",
  "hub.row.installed": "installed",
  // v1.0.3: context file editor.
  "context.edit.h1": "Edit context",
  "context.edit.subtitle": "{filename} — {location}",
  "context.edit.noPath": "No file selected. Open a file from /context to edit it.",
  "context.edit.notFound": "That file isn't in the discovered context set. It may have been deleted or is outside cwd.",
  "context.edit.back": "← Back to /context",
  "context.edit.readonly": "This file is informational only — Pilot surfaces it for visibility but doesn't author it.",
  "context.edit.saving": "Saving…",
  "context.edit.savedAt": "Saved at",
  "context.edit.unsaved": "Unsaved changes",
  ...
  // v2.0.6: gateway cards.
  "workflow.sub.compose.title": "Compose",
  "workflow.sub.compose.desc": "Visual canvas — drag entities from the sidebar, persist to localStorage, export/import JSON.",
  "workflow.sub.plans.title": "Plans",
  "workflow.sub.plans.desc": "Decompose a goal into Tasks and Steps; track status (draft / running / completed / failed).",
  "workflow.sub.workflows.title": "Workflows",
  "workflow.sub.workflows.desc": "Reusable agent workflow templates — export, import, share.",
  "settings.sub.profiles.title": "Profiles",
  "settings.sub.profiles.desc": "Saved capability bundles: model + tools + thinking. Switch per project.",
  "settings.sub.avatars.title": "Avatars",
  ...
  "hub.tools.empty.title": "No tools registered",
  "hub.tools.empty.hint": "Install a npm extension or write a project-local extension to add tools.",
  "hub.tool.safety.read": "read",
  "hub.tool.safety.write": "write",
  "hub.tool.safety.exec": "exec",
  "hub.tool.safety.network": "network",
  "hub.tool.safety.secret": "secret",
  "hub.tool.source.built-in": "built-in",
  "hub.tool.source.npm": "npm",
  "hub.tool.source.extension": "extension",
  "hub.tool.enabled": "on",
  "hub.tool.disabled": "off",
  ...
  // v1.0.1: 5 new nav hint tooltips.
  "nav.hint.hub": "Search, install, and manage agent capabilities",
  "nav.hint.workflow": "Visual orchestration of multi-step tasks",
  "nav.hint.policySafe": "Tool safety rules + input/output transforms",
  "nav.hint.insight": "Real-time dashboard, alerts, and cost analysis",
  "nav.hint.settings": "Profiles, avatars, and system preferences",
  ...
  "observability.chat.clear": "Clear history",
