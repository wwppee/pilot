...
const zh: Dict = {
  ...
  "hub.h1": "能力中心",
  "hub.subtitle": "搜索 / 安装 / 管理 agent 能力",
  "workflow.h1": "工作流",
  "workflow.subtitle": "可视化编排多步任务",
  "insight.h1": "洞察",
  "insight.subtitle": "实时看板 + 告警 + 成本分析",
  "settings.h1": "设置",
  "settings.subtitle": "profile / avatar / 系统设置",
  // v1.0.1: 4 个新 placeholder page 的"即将到来"提示。
  "hub.comingSoon.title": "能力中心 v1.0.2 上线",
  "hub.comingSoon.body": "能力中心会把 4 个老入口(包 / Forge / 能力 / 工具)合并成一个搜索驱动的页面。在此之前, 下方老 URL 仍能用, 全部跳到这里。",
  "hub.comingSoon.routes": "跳转到这里的老 URL:",
  "workflow.comingSoon.title": "工作流 v1.0.2 上线",
  "workflow.comingSoon.body": "工作流会把编排(画布)/ 计划(目标分解)/ 工作流(可复用模板)合并成一个编辑器。画布仍是主视图, 底层数据模型统一。",
  "workflow.comingSoon.routes": "跳转到这里的老 URL:",
  "insight.comingSoon.title": "洞察 v1.0.2 上线",
  "insight.comingSoon.body": "洞察模块会把可观测性(原始工具调用记录)/ 用量(今日 / 本周 token + USD)合并成一个实时看板。告警规则 + 调用链追踪在 v1.0.3 / v1.0.4 跟进。",
  "insight.comingSoon.routes": "跳转到这里的老 URL:",
  // v1.1.0: 真实 Insight 页面文案。
  "insight.stat.sessions": "会话",
  "insight.stat.messages": "消息",
  "insight.stat.tokens": "Token",
  "insight.stat.cost": "成本 (USD)",
  "insight.section.byModel": "按模型",
  "insight.section.byTool": "按工具",
  "insight.section.recent": "最近会话",
  "insight.empty.models": "今日还没模型使用记录。",
  "insight.empty.tools": "今日还没工具调用记录。",
  "insight.empty.sessions": "今日还没会话。",
  "insight.col.id": "ID",
  "insight.col.cwd": "工作目录",
  "insight.col.lastUsed": "最后使用",
  "insight.col.entries": "条目数",
  "insight.footer.legacy": "合并中, 2 个老页面仍可用:",
  "settings.comingSoon.title": "设置 v1.0.2 上线",
  "settings.comingSoon.body": "设置模块会把 profile / avatar / help 合并成一个 tabbed 页面, 加上一个新的系统 tab(主题 / 语言 / 数据清理)。底层存储不变, 只是 1 个菜单入口替 3 个。",
  "settings.comingSoon.routes": "跳转到这里的老 URL:",
  // v1.0.2: Hub 页面文案。
  "hub.subtitle.idle": "搜索 npm / 本地 / 内置能力, 一键安装。",
  "hub.subtitle.search": "“{q}” 共 {n} 个结果。",
  "hub.section.searchResults": "搜索结果",
  "hub.section.installed": "已装",
  "hub.section.capabilities": "能力库",
  "hub.installedCount": "{n} 个包",
  "hub.capCount": "{n} 个能力",
  "hub.search.placeholder": "搜索能力(例如 csv parser / jwt / mongodb)",
  "hub.search.submit": "搜索",
  "hub.search.empty.title": "“{q}” 没找到结果",
  "hub.search.empty.hint": "换个短一点的关键词, 或者检查拼写。",
  "hub.installed.empty.title": "还没装任何东西",
  "hub.installed.empty.hint": "用上面的搜索框找能力, 一键安装。",
  "hub.capabilities.empty.title": "还没吸收能力",
  "hub.capabilities.empty.hint": "用 Forge 吸收一个包, 跨项目复用。",
  "hub.capabilities.empty.hintForge": "打开 Forge →",
  "hub.footer.legacy": "合并中, 4 个老页面仍可用:",
  "hub.action.install": "安装",
  "hub.action.uninstall": "卸载",
  "hub.action.view": "查看",
  "hub.row.version": "v",
  "hub.row.author": "作者",
  "hub.row.installed": "已装",
  // v1.0.3: context 文件编辑器。
  "context.edit.h1": "编辑上下文",
  "context.edit.subtitle": "{filename} — {location}",
  "context.edit.noPath": "没选文件。 从 /context 打开一个文件来编辑。",
  "context.edit.notFound": "该文件不在已发现的上下文集合里。 可能被删了, 或者不在 cwd 下。",
  "context.edit.back": "← 回到 /context",
  "context.edit.readonly": "该文件仅供参考 — Pilot 把它显示出来, 但不会改它。",
  "context.edit.saving": "保存中…",
  "context.edit.savedAt": "已保存于",
  "context.edit.unsaved": "有未保存的修改",
  ...
  // v2.0.6: 网关卡片。
  "workflow.sub.compose.title": "编排",
  "workflow.sub.compose.desc": "可视化画布 — 从侧边栏拖实体, 持久化到 localStorage, 导出/导入 JSON。",
  "workflow.sub.plans.title": "计划",
  "workflow.sub.plans.desc": "把目标分解为 Tasks / Steps; 跟踪状态(草稿 / 运行中 / 完成 / 失败)。",
  "workflow.sub.workflows.title": "工作流",
  "workflow.sub.workflows.desc": "可复用的 agent 工作流模板 — 导出, 导入, 分享。",
  "settings.sub.profiles.title": "配置",
  "settings.sub.profiles.desc": "保存的能力包: model + tools + thinking。 按项目切换。",
  ...
  "hub.tools.empty.title": "还没注册任何工具",
  "hub.tools.empty.hint": "装一个 npm 扩展或写一个项目本地扩展来添加工具。",
  "hub.tool.safety.read": "读",
  "hub.tool.safety.write": "写",
  "hub.tool.safety.exec": "执行",
  "hub.tool.safety.network": "网络",
  "hub.tool.safety.secret": "密钥",
  "hub.tool.source.built-in": "内置",
  "hub.tool.source.npm": "npm",
  "hub.tool.source.extension": "扩展",
  "hub.tool.enabled": "开",
  "hub.tool.disabled": "关",
  ...
  "nav.hint.workflows": "可复用的 agent 工作流模板",
  "nav.hint.profiles": "保存的能力包（model + tools）",
  "nav.hint.help": "术语表 + 新手指引",
  // v1.0.1: 5 new nav hint tooltips.
  "nav.hint.hub": "搜索 / 安装 / 管理 agent 能力",
  "nav.hint.workflow": "可视化编排多步任务",
  "nav.hint.policySafe": "工具安全规则 + 输入输出转换",
  "nav.hint.insight": "实时看板 + 告警 + 成本分析",
  "nav.hint.settings": "profile / avatar / 系统设置",
  ...
  "compose.connection.route.label": "路径",
  "compose.connection.route.curve": "曲线",
  "compose.connection.route.orthogonal": "直角",
  "compose.announce.connectionRouteUpdated": "连接路径：{route}",
  ...
  // v0.7.0: workflows — 可复用的 agent 工作流模板。
  // 详见 `core/workflow.ts` 持久化模型 + `/workflows` 编辑器。
  "workflows.h1": "工作流",
  "workflows.subtitle":
    "可复用的 agent 工作流 —— 把好用的模式存下来，改改变量就能重复用。",
  "workflows.empty": "还没有工作流。",
  "workflows.empty.hint": "创建一个来记录好用的模式。",
  ...
  "workflows.notFound": "找不到这个工作流。",
  "workflows.newIdPrompt": "工作流 id",
  "workflows.newIdHint": 'kebab-case 标识符，例如 "research-and-test"',
  "workflows.invalidId": "id 必须是 kebab-case（小写字母、数字、横线）",
  "workflows.field.name": "名称",
  "workflows.field.description": "描述",
  "workflows.field.id": "Id",
  "workflows.field.provider": "供应商",
  "workflows.field.model": "模型",
  ...
  "workflows.field.position": "位置",
  "workflows.field.retryCount": "重试次数",
  "workflows.field.escalateToModel": "升级到模型",
  "workflows.onFailure.stop": "停止整个工作流",
  "workflows.onFailure.skip": "跳过这一步，继续",
  "workflows.onFailure.retry": "重试同一个模型",
  "workflows.onFailure.escalate": "用更强的模型重试",
  "workflows.provider.anthropic": "Anthropic",
  "workflows.provider.openai": "OpenAI",
  "workflows.provider.google": "Google",
  "workflows.provider.ollama": "Ollama（本地）",
  "workflows.provider.custom": "自定义端点",
  "workflows.editor.addNode": "添加步骤",
  "workflows.editor.removeNode": "删除",
  "workflows.editor.addEdge": "连接到…",
  "workflows.editor.removeEdge": "断开",
  "workflows.editor.noNodes": "还没有步骤。点「添加步骤」开始。",
  "workflows.editor.noEdges": "还没有连接。步骤按你连接的顺序执行。",
  "workflows.editor.preview": "预览",
  "workflows.editor.save": "保存",
  "workflows.editor.saved": "已保存。",
  "workflows.editor.saveFailed": "保存失败。检查 id 是否是 kebab-case。",
  "workflows.editor.duplicate": "复制",
  "workflows.editor.delete": "删除",
  "workflows.editor.layoutHint":
    "提示：预览反映数据模型，不是添加节点的顺序。点「自动布局」整理。",
  "workflows.layoutBtn": "自动布局",
  ...
  // v0.9.0 (A2 — 工具包装器): /wrappers 面板。
  "wrappers.h1": "工具包装器",
  "wrappers.subtitle":
    "工具包装器在工具运行前转换调用（失败时重试、写独立审计日志、改写参数）。与策略面板平行。",
  "wrappers.loadErrorTitle": "无法加载包装器",
  "wrappers.empty.title": "暂无包装器",
  "wrappers.empty.body": "在下方创建一个包装器，给一个或多个工具加转换。",
  "wrappers.card.applied": "已应用",
  "wrappers.card.notApplied": "未应用",
  "wrappers.card.kind": "类型：",
  "wrappers.card.tools": "工具：",
  "wrappers.apply": "应用",
  "wrappers.unapply": "取消应用",
  "wrappers.delete": "删除",
  "wrappers.applyOk": "✓ 已写入占位扩展至 {path}（{bytes} 字节）。",
  "wrappers.applyFailed": "应用失败",
  "wrappers.unapplyOk": "扩展已移除。",
  "wrappers.unapplyNotApplied": "扩展未应用。",
  "wrappers.unapplyFailed": "取消应用失败",
  "wrappers.deleteFailed": "删除失败",
  "wrappers.confirmDelete": "删除包装器 {name}？",
  "wrappers.newCard.title": "新建包装器",
  "wrappers.newCard.subtitle":
    "选一个类型，给它一个 kebab-case 名字，包装器会保存到 ~/.pilot/wrappers/。",
  "wrappers.newCard.nameLabel": "名称",
  "wrappers.newCard.namePlaceholder": "bash-retry",
  "wrappers.newCard.nameRequired": "名称必填",
  "wrappers.newCard.kindLabel": "类型",
  "wrappers.newCard.kindRetry": "失败时重试",
  "wrappers.newCard.kindLog": "记录到审计日志",
  "wrappers.newCard.kindTransform": "改写参数",
  "wrappers.newCard.toolsLabel": "工具（逗号分隔）",
  "wrappers.newCard.submit": "创建",
  "nav.wrappers": "包装器",
  // v0.9.3: 包装器编辑表单。
  "wrappers.edit.h1": "编辑包装器",
  "wrappers.edit.backToList": "← 返回包装器",
  "wrappers.edit.deleteTitle": "删除包装器？",
  "wrappers.error.notFound": "找不到包装器：",
  "loading.wrapperForm": "正在加载表单…",
  "wrappers.form.ariaEdit": "编辑包装器 {name}",
  "wrappers.form.savedClean": "✓ 已保存",
  "wrappers.form.savedAt": "✓ 已保存于 {time}",
  "wrappers.form.errorPrefix": "错误：{msg}",
  "wrappers.form.saveFirstApply": "请先保存修改，再应用。",
  "wrappers.form.descriptionLabel": "描述",
  "wrappers.form.descriptionPlaceholder": "此包装器的作用",
  "wrappers.form.toolsLabel": "工具（逗号分隔）",
  "wrappers.form.toolsHint": "此包装器适用的工具名（如 bash, write）。",
  "wrappers.form.kindLabel": "规则类型",
  "wrappers.form.maxRetriesLabel": "最大重试次数 (1-10)",
  "wrappers.form.initialBackoffLabel": "初始退避 (ms)",
  "wrappers.form.initialBackoffHint": "每次重试翻倍。1000 = 1 秒。",
  "wrappers.form.logPathLabel": "日志路径（相对于 home）",
