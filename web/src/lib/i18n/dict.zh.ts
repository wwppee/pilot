...
const zh: Dict = {
  ...
  "nav.playground": "试玩",
  "playground.h1": "Pi 试玩",
  "playground.body": "v0.5.14+ — Pilot 与",
  "playground.bodyWs": "通过 WebSocket 桥接，每个浏览器标签页启动一个全新的",
  "playground.bodySpawn": "子进程。",
  "playground.status.idle": "点击 Connect 开始",
  "playground.status.fetchingToken": "读取授权令牌…",
  "playground.status.connecting": "建立 WebSocket…",
  "playground.status.connected": "已连接 — pi 正在后台运行",
  "playground.status.disconnected": "已断开",
  "playground.status.errorUnknown": "错误：未知",
  "playground.action.connect": "连接",
  "playground.action.disconnect": "断开",
  "playground.action.send": "▶ 发送",
  "playground.action.newSession": "↻ 新会话",
  "playground.action.abort": "⏹ 中止",
  "playground.prompt.label": "Prompt",
  "playground.prompt.placeholder": '例如："列出当前目录的文件"',
  "playground.events.title": "事件流",
  "playground.events.clear": "清空",
  "playground.events.emptyConnected": "已连接。发送 prompt 即可看到流式事件。",
  "playground.events.emptyDisconnected": "未连接。",
  // v0.4.14: nav groups
  "nav.groupInspect": "查看",
  "nav.groupManage": "管理",
