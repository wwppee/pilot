    ...
    try {
      ...
      const entries = [
        ...
        },
        {
          ...
          data: { model: "claude-opus-4.6", text: "hi" },
        },
        {
          id: "c",
          parentId: "b",
          type: "tool",
          timestamp: "2026-06-30T10:00:06Z",
          data: { name: "read" },
        },
      ];
    ...
    try {
      ...
      const content = [
        JSON.stringify({
          id: "a",
          type: "user",
          data: { text: "add JWT auth middleware" },
        }),
        JSON.stringify({
          id: "b",
          type: "assistant",
          data: { text: "adding jwt middleware" },
        }),
        JSON.stringify({
          id: "c",
          type: "tool",
          data: { name: "read", path: "src/server.ts" },
        }),
      ].join("\n");
      writeFileSync(path, content);
    ...
    try {
      ...
      const entries = [
        ...
        },
        {
          ...
          parentId: "c",
          type: "assistant",
          timestamp: "2026-06-30T10:00:15Z",
          data: { model: "claude-opus-4.6", text: "fine" },
        },
      ];
      writeFileSync(path, entries.map((e) => JSON.stringify(e)).join("\n"));
    ...
    try {
      ...
      const entries = [
        ...
        },
        {
          ...
          parentId: "e",
          type: "assistant",
          timestamp: "2026-06-30T10:00:25Z",
          data: { model: "claude-opus-4.6", text: "c" },
        },
      ];
      writeFileSync(path, entries.map((e) => JSON.stringify(e)).join("\n"));
