...
describe("PackManifestSchema", () => {
  ...
  it("accepts extension as string or array", () => {
    const a = PackManifestSchema.parse({
      name: "x",
      version: "1",
      pi: { extension: "dist/a.js" },
    });
    expect(a.pi?.extension).toBe("dist/a.js");
    const b = PackManifestSchema.parse({
      name: "x",
      version: "1",
      pi: { extension: ["a.js", "b.js"] },
    });
...
describe("classifyFromManifest", () => {
  it("uses manifest.pi.kind when present", () => {
    expect(
      classifyFromManifest(
        { name: "foo", version: "1", pi: { kind: "theme" } },
        "foo",
      ),
    ).toBe("theme");
    expect(
      classifyFromManifest(
        { name: "foo", version: "1", pi: { kind: "skill" } },
        "foo",
      ),
    ).toBe("skill");
  });
  ...
  it("uses artifact presence when kind is missing", () => {
    expect(
      classifyFromManifest(
        { name: "foo", version: "1", pi: { themes: ["t.json"] } },
        "foo",
      ),
    ).toBe("theme");
    expect(
      classifyFromManifest(
        { name: "foo", version: "1", pi: { prompts: ["p.md"] } },
        "foo",
      ),
    ).toBe("prompt");
    expect(
      classifyFromManifest(
        { name: "foo", version: "1", pi: { skills: ["s.md"] } },
        "foo",
      ),
    ).toBe("skill");
    expect(
      classifyFromManifest(
        { name: "foo", version: "1", pi: { extension: "e.js" } },
        "foo",
      ),
    ).toBe("extension");
  });
